...
-->
			...
			<div class="controls">
			<input value="<?php echo $query->fecha_desde; ?>" type="text" class="form-control" name="fecha_desde" />
			...
			<div class="controls">
			<input value="<?php echo $query->fecha_hasta; ?>" type="text" class="form-control" name="fecha_hasta" />
