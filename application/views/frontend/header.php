			...
			<div class="container">
				...
				<div class="collapse navbar-collapse align-items-center flex-sm-row g-pt-10 g-pt-5--lg g-mr-40--lg" id="navBar">
					<ul class="navbar-nav text-uppercase g-pos-rel g-font-weight-600 ml-auto">
						...
						<!-- Registro -->
						<li class="nav-item  g-mx-10--lg g-mx-15--xl">
							<a href="<?php echo base_url('registro'); ?>" class="nav-link g-py-7 g-px-0">Registro</a>
						</li>
						<!-- End Registro -->

						<!-- logout -->
						<li class="nav-item  g-mx-10--lg g-mx-15--xl">
							<a href="<?php echo base_url('logout'); ?>" class="nav-link g-py-7 g-px-0">logout</a>
						</li>
						<!-- End logout -->

						<!-- Login -->
						<li class="nav-item  g-mx-10--lg g-mx-15--xl">
							<a href="<?php echo base_url('login'); ?>" class="nav-link g-py-7 g-px-0">login</a>
						</li>
						<!-- End Login -->
