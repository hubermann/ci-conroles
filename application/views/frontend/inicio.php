      ...
      <div class="col-md-4 g-px-5 g-mb-20 g-mb-0--md">
        <div class="media">
          ...
          <div class="media-body text-uppercase">
            ...
            <h3 class="h3 text-uppercase g-font-size-15 g-color-white mb-0">18:30, 12 Jul, 2017</h3>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-5 g-px-5 g-mb-20 g-mb-0--md">
        <div class="media">
          ...
          <div class="media-body text-uppercase">
            ...
            <h3 class="h3 text-uppercase g-font-size-15 g-color-white mb-0">Concert Hall, Algun Place, PALERMO</h3>
          </div>
        </div>
      </div>
