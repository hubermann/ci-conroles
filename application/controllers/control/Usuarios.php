...
$this->form_validation->set_rules('depto', 'Depto', 'required');
...
$this->form_validation->set_rules('telcelular', 'Telcelular', 'required');
...
$this->form_validation->set_rules('celular_cia', 'Celular_cia', 'required');

$this->form_validation->set_rules('tel_citas', 'Tel_citas', 'required');

$this->form_validation->set_rules('validado', 'Validado', 'required');

$this->form_validation->set_rules('hijos', 'Hijos', 'required');

$this->form_validation->set_rules('codigo_verificacion', 'Codigo_verificacion', 'required');

$this->form_validation->set_rules('negocios', 'Negocios', 'required');

$this->form_validation->set_rules('cod_postal', 'Cod_postal', 'required');

$this->form_validation->set_rules('religion', 'Religion', 'required');

$this->form_validation->set_rules('foto_main', 'Foto_main', 'required');
...
$this->form_validation->set_rules('convivencia', 'Convivencia', 'required');
...
$this->form_validation->set_rules('myspace', 'Myspace', 'required');

$this->form_validation->set_rules('badoo', 'Badoo', 'required');

$this->form_validation->set_rules('msn', 'Msn', 'required');
...
$this->form_validation->set_rules('completa_signin', 'Completa_signin', 'required');

$this->form_validation->set_rules('claves_erroneas', 'Claves_erroneas', 'required');

$this->form_validation->set_rules('id_paises', 'Id_paises', 'required');
...
public function delete(){
	...
	if ($this->form_validation->run() === FALSE){
		...
		$prod = $this->usuario->get_record($this->input->post('id'));
			$path = 'images-usuarios/'.$prod->filename;
			if(is_link($path)){
				unlink($path);
			}
		...
		$this->usuario->delete_record($id_item);
		redirect('control/usuarios', 'refresh');
